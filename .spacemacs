...
(defun dotspacemacs/layers ()
  ...
  (setq-default
   ...
   dotspacemacs-additional-packages '(hi2)
...
before layers configuration."
  ...
  ;; (add-hook 'haskell-mode-hook 'config-haskell)
)

(defun config-haskell ()
  (turn-on-hi2)
...
(custom-set-variables
 ...
 '(org-todo-keywords (quote ((sequence "TODO" "DOING" "REVIEW" "DONE"))))
